...
INSERT INTO countries(country_id,country_name,region_id) VALUES ('IL','Island',4);
...
INSERT INTO managers(manager_id,first_name,last_name,hire_date,salary,job_id,department_id, supervisor_id) 
VALUES (100,'John','Doe','2020-01-15',70000.00,1,11,null),
       (101,'Jane','Smith','2019-03-22',75000.00,7,10,100),
       (102,'Alice','Brown','2018-07-10',80000.00,10,2,100),
       (103,'Bob','Taylor','2017-11-05',72000.00,14,3,101),
       (104,'Charlie','Johnson','2016-06-18',90000.00,15,8,101),
       (114,'David','wilson','2021-02-25',85000.00,19,9,100);
 
 -- data for the clients
 
 INSERT INTO clients(client_name,industry,adress,email, phone_number) 
	VALUES('teck solution','technology','123 silicon valley , ca ,usa','contact@techsolutions.com','+1 415 555 1234'),
          ('globale finance','finance','456 wall street , ny ,usa','info@globalfinance.com','+1 212 555 5678'),
          ('medicare ','healthcare','789 medical road , la ,usa','support@medicare.com','+1 310 555 9876'),
          ('ecogreen ','energy','789 green street , berlin ,germany','info@ecogreen.com','+49 30 555 5678'),
          ('medipharma','healthcare','456 health ave , paris ,france','support@medipharma.com','+33 1 555 9876');
 
 -- data for hr_service	
 
 INSERT INTO hr_services(client_id,service_type,start_date,end_date,service_status)
   VALUES(1,'recruitment','2024-01-15','2024-03-15','completed'),
         (2,'training','2024-02-01','2024-02-28','completed'),
         (3,'consulting','2024-03-10',NULL,'ongoing'),
         (4,'payrol','2024-03-01','2024-12-31','ongoing'),
         (1,'other','2024-01-20','2024-01-25','cancelled');
         
         
 -- data for claimss_raw
 INSERT INTO claimss_raw(client_id,claim_date,claim_amount,claim_type,claim_statuts,description)
	VALUES(1,'2025-02-10',1500.00,'health','submitted','reimbursement for hospitalization due to a serve illness'),
          (2,'2025-02-12',3000.00,'vehicle','under review','accident repair costs,including towing services'),
		  (3,'2025-02-15',1200.00,'property','approved','reimbursement for home appliance damage caused by a power surge'),
          (4,'2025-02-18',450.00,'travel','rejected','claim for cancellation of travel due to personal reasons'),
          (5,'2025-02-20',2200.00,'other','submitted','reimbursement for lost baggage during a flight');
...
-- data for salaries
 ...
 INSERT INTO salaries(employee_id,salary_amount,salary_date,bonus,tax_deductions)
   VALUES(100,3500.00,'2025-01-15',500.00,200.00),
		 (103,4200.00,'2025-01-26',600.00,250.00),
         (116,2800.00,'2025-01-30',400.00,150.00),
         (176,3900.00,'2025-02-04',550.00,180.00),
         (108,4700.00,'2025-03-08',700.00,300.00);
   

 -- data for promotions
 
 INSERT INTO promotions(employee_id,old_job_title,new_job_title,old_salary,new_salary,promotion_date,reason,approved_by) 
VALUES(107,'junior developer','senior developer',3500.00,4500.00,'2025-01-16','performance exceptionelle',104),
      (201,'marketing assistant','marketing manager',3000.00,4000.00,'2025-02-02','promotion basé sur lancienté',114),
	  (106,'junior analyst','senior analyst',3200.00,4200.00,'2025-02-12','augmentation de responsabilité',103),
	  (113,'accountant','accountant senior',4500.00,5500.00,'2025-03-05','reconnue par son expertise',109),
	  (146,'sales associate','sales manager',3500.00,4800.00,'2025-03-10','reorganisation de lequip de vente',145)
  ...
  INSERT INTO retirements (employee_id,retirement_date,age_at_retirement,eligibility_date,pension_amount,statuts,description) 
VALUES(100,'2025-06-30',65,'2025-01-01',2500.00,'pending','eligible for retirrtement benefits'),
      (101,'2024-12-31',62,'2024-07-01',2300.75,'retired','early  retirrtement with partial benefits'),
      (200,'2026-09-15',67,'2026-03-01',2800.00,'deferred','deferred due to service extention '),
      (103,'2025-03-01',60,'2024-09-01',2200.00,'pending','optional retirrtement request under review ');
      
-- data turnvor
  
  INSERT INTO turnover (employee_id,departure_date,departure_reason,resignation_reason,statuts,feedback) 
  values(100,'2025-06-30','retirement','better job opportunity','processed','smooth transition'),
        (110,'2025-04-15','resignation','reached retirement age','processed','long tenure, honored by company'),
        (119,'2024-11-20','termination','performance issues','pending','employee given notice period'),
        (203,'2025-09-05','other','personal reasons','processed','employee left a good terms');

  -- data absence
  
  insert into absences (employee_id,absence_type,start_date,end_date ,statuts,approved_by)
  values(104,'sick leave','2025-03-10','2025-03-14','approved',102),
        (116,'paid leave','2025-07-10','2025-07-25','pending',114),
        (202,'maternity leave','2025-05-20','2025-08-20','approved',104),
        (123,'unpaid leave','2025-09-05','2025-09-10','rejected',103),
        (146,'worck accident','2025-03-15','2025-03-22','approved',100);
  
 -- data for managers
   
          
INSERT INTO managers(manager_id,first_name,last_name,hire_date,salary,job_id,department_id,supervisor_id) 
VALUES (120,'Emma','Moore','2022-09-13',68000.00,1,null,null);
